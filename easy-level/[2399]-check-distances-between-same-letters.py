...
# --------------- Runtime 60 ms, beats 12.48%. Memory 16.3MB, beats 5.13% ---------------
...
class Solution:
    def checkDistances(self, s: str, distance: List[int]) -> bool:
        for letter in set(s):
            first_letter = s.index(letter)
            second_letter = s.index(letter, first_letter + 1)
            position = ord(letter) - 97

            if (second_letter - first_letter - 1) != distance[position]:
                return False
...
# --------------- Runtime 61 ms, beats 9.91%. Memory 16.2MB, beats 17.9% ---------------
...
class Solution2:
    def checkDistances(self, s: str, distance: List[int]) -> bool:
        ...
        for char, dist in letters.items():
