...
# Solving question i will earn you pointsi points but you will be unable to solve each of
...
# --------------- Runtime 1643 ms, beats 69.14%. Memory 71MB, beats 49.38% ---------------
...
class Solution:
    def mostPoints(self, questions: List[List[int]]) -> int:
        ...
        for i in range(len(questions) - 1, -1, -1):
            ...
            dp[i] = max(
                dp.get(brainpower + i + 1, 0) + points,
                dp.get(i + 1, 0)
            )
...
# --------------- Runtime 1767 ms, beats 23.87%. Memory 155.9MB, beats 31.28% ---------------
