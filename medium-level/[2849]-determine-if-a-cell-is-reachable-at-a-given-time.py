...
# exactly 6 seconds by going through the cells depicted in the picture above.
...
# --------------- Runtime 40 ms, beats 56.59%. Memory 16.3MB, beats 73.40% ---------------
...
class Solution:
    def isReachableAtTime(self, sx: int, sy: int, fx: int, fy: int, t: int) -> bool:
        ...
        elapsed_time = max(abs(fx - sx), abs(fy - sy))
